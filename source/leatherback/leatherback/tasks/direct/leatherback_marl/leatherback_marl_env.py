...
from .leatherback_marl_env_cfg import LeatherbackMarlEnvCfg


class LeatherbackMarlEnv(DirectMARLEnv):
    cfg: LeatherbackMarlEnvCfg

    def __init__(self, cfg: LeatherbackMarlEnvCfg, render_mode: str | None = None, **kwargs):
